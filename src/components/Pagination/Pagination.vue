...
<script setup>
    ...
    function createNums (page) {
        ...
        endLinks.value = nextDots.value ? [lastPage--, lastPage].reverse() : page == lastPage - 3 ? [lastPage--,lastPage--,lastPage--,lastPage--, lastPage].reverse() : [lastPage--,lastPage--,lastPage--,lastPage].reverse();
